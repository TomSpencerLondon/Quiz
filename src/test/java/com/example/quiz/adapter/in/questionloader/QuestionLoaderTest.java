...
public class QuestionLoaderTest {
  ...
  void changes_question_text_to_a_question() {
    ...
    assertThat(question.text())
        .isEqualTo("Using a Callable would be more appropriate than using a Runnable in which of the following situations?");

    assertThat(question.correctAnswer())
        .isEqualTo(new Answer("When your task might throw a checked exception and you want to execute it in a separate Thread."));
  }
}
